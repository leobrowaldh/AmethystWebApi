    ...
    public async Task<ResponsePageDto<IComment>> ReadItemsAsync(bool seeded, bool flat, string filter, int pageNumber, int pageSize)
    {
        ...
        var ret = new ResponsePageDto<IComment>()
        {
            ...
            .Where(i => (i.Seeded == seeded) && 
                        (i.CommentName.ToLower().Contains(filter) ||
                         i.strType.ToLower().Contains(filter) ||
                         i.strRating.ToLower().Contains(filter) ||
                         i.CommentAge.ToString().Contains(filter) ||
                         i.CommentText.ToLower().Contains(filter))).CountAsync(),
            ...
            .Where(i => (i.Seeded == seeded) && 
                        (i.CommentName.ToLower().Contains(filter) ||
                         ...
                         i.strRating.ToLower().Contains(filter) ||
                         i.CommentAge.ToString().Contains(filter) ||
                         i.CommentText.ToLower().Contains(filter)))
